...
int main() {
	...
	size_t size = 52428800ULL * 120;   // 24000 MB entries * 4B = 24GB
	size_t processing = 52428800ULL * 30; // 6000 MB entries * 4B = 6GB
	size_t pinned = 52428800ULL * 30;     // 6000 MB entries * 4B = 6GB
	double alpha = 1.0;
	bool custom = true;
	bool skipping = true;
